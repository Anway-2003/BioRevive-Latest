  ...
  return (
    <div className="w-full relative">
      ...
      <div className="block md:hidden min-h-screen bg-[#F8FAFC] font-sans pb-24 relative flex flex-col">
        ...
        {/* 🔥 FIX: ONE SOLID STICKY CONTAINER FOR HEADER + SELECTOR + TABS */}
          ...
          <div className="px-4 pb-3">
            <div className="bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 flex items-center">
              ...
              <select 
                ...
                className="bg-transparent text-xs font-extrabold text-gray-800 outline-none w-full cursor-pointer"
              >
          ...
          <div className="px-4 py-3 border-t border-gray-100 flex overflow-x-auto gap-2 custom-scrollbar">
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-1.5 text-xs font-bold rounded-full whitespace-nowrap transition-all cursor-pointer ${
                  activeCategory === cat
        ...
        <div className="flex flex-wrap gap-3 bg-white p-3 rounded-2xl shadow-sm border border-gray-100 mb-8">
          {categories.map((cat) => (
            <button
              key={cat}
              onClick={() => setActiveCategory(cat)}
              className={`px-6 py-2.5 text-sm font-bold rounded-xl transition-all cursor-pointer ${
                activeCategory === cat
